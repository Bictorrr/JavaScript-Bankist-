...
//     }
//   }
//   const adultDog = arr.filter(ar => ar > 18);
//   const avgAge =
//     adultDog.reduce((acc, cur, i, arr) => (cur += acc), 0) / adultDog.length;
...
// console.log(`${ownersEatTooMuch.join(' and ')}'s eat too little!`);
...
//   dog.recFood * 1.1 > dog.curFood && dog.curFood > dog.recFood * 0.9;
